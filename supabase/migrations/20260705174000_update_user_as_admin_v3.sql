...
create or replace function public.update_user_as_admin_v3(
  target_user_id uuid,
...
revoke all on function public.update_user_as_admin_v3(uuid, text, text, text, text, text) from public;
grant execute on function public.update_user_as_admin_v3(uuid, text, text, text, text, text) to authenticated;
